...
class MovementService extends _api_service__WEBPACK_IMPORTED_MODULE_1__["Service"] {
    ...
    getItemsAllLotsWarehouse(filter) {
        return this.https.post(this.URL_API + `all-lots-warehouse/`, filter).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((items) => {
            this.items = items;
        }));
    }
}
MovementService.ɵfac = function MovementService_Factory(t) { return new (t || MovementService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"])); };
...
class Service {
    ...
    getItemsAllId(id) {
        return this.http.get(this.URL_API + `all/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((items) => {
            this.items = items;
        }));
    }
    ...
    getItemsAllIdRuta(id, ruta) {
        return this.http.get(this.URL_API + `${ruta}/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((items) => {
            this.items = items;
        }));
    }
    getItemNotStore(id) {
...
/* harmony import */ var _services_measure_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/measure.service */ "yiDH");
/* harmony import */ var _services_provider_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./services/provider.service */ "gs/X");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [{
        ...
        _services_measure_service__WEBPACK_IMPORTED_MODULE_23__["MeasureService"],
        _services_provider_service__WEBPACK_IMPORTED_MODULE_24__["ProviderService"],
    ], imports: [[
...
class ProviderService extends _api_service__WEBPACK_IMPORTED_MODULE_1__["Service"] {
    constructor(https) {
        super(https, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api + '/provider/');
        this.https = https;
    }
}
ProviderService.ɵfac = function ProviderService_Factory(t) { return new (t || ProviderService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
...
/***/ "yiDH":
/*!*********************************************!*\
  !*** ./src/app/services/measure.service.ts ***!
  \*********************************************/
...
class MeasureService extends _api_service__WEBPACK_IMPORTED_MODULE_1__["Service"] {
    constructor(https) {
        super(https, _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api + '/measure/');
        this.https = https;
    }
}
MeasureService.ɵfac = function MeasureService_Factory(t) { return new (t || MeasureService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
